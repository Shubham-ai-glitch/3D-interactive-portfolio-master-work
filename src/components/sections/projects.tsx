...
const certs = [
  { 
    ...
    para: "Successfully qualified as a Certified Cybersecurity Educator Professional (CCEP) through Red Team Leaders on December 7, 2025. This certification confirms expertise in leading red team operations." 
  },
  { 
    title: "Cybersecurity & Ethical Hacking", 
    img: "/assets/cert1.jpg", 
    para: "Awarded by Cyber Ethics Academy on December 20, 2025. Mastered ethical hacking methodologies and proactive defense strategies to safeguard digital assets." 
  },
  { 
    title: "Advance Java (online)", 
    img: "/assets/cert3.jpg", 
    para: "Completed an intensive Advance Java course from P-INFOWIZ IT Training on January 15, 2026. Strengthened backend foundation for scalable software solutions." 
  }
];
